...
const Job_posting = () => {
    ...
    const HandleNext_stage = async () => {
        ...
        if (nextSatge === 3) {
            isValid = await trigger(["minBudget",
                "maxBudget",
                "timeline"])
        }
    ...
    const onSubmit = (data) => {
        ...
        //     attachment: FilePreview || null
        // };

        // console.log("FINAL JOB DATA:", formData);
                ...
                `}
                                            ...
                                            <div className="">
                                                ...
                                                <input
                                                    ...
                                                    className={`w-full h-12 pl-8 pr-4 rounded-xl border bg-gray-50
                    focus:ring-2 focus:ring-primary focus:border-primary outline-none
                    ${errors.timeline ? "border-red-500 focus:ring-red-200" : "border-gray-300"}
                `}
