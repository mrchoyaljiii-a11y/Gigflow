...
function SectionHeader({ icon: Icon, title, showEdit = true }) {
  return (
...
const Client_MYprofile = () => {
  ...
  const personalFields = [
    ...
    { icon: FaPhoneAlt, label: "Phone Number", value: "+91 12345 67890" },
  ...
  const contactRows = [
...

    {
      icon: "linkedin",
      label: "LinkedIn",
      value: Links?.linkedinLink ? Links?.websiteLink : false,
          ...
          <div className="w-full rounded-3xl  overflow-hidden">
            ...
            <div className='grid lg:grid-cols-3 gap-2'>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm col-span-2">
                <SectionHeader title="Company Information" icon={LuBuilding2} />
                ...
                <div className="flex gap-4 mb-5">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-3">
                      <h3 className="text-base font-bold text-gray-900">Barmunda private Solutions</h3>
              ...
              <div className="bg-white border border-gray-200 rounded-3xl p-4 shadow-sm w-full">
                <SectionHeader title="Skills you hiring for" icon={FaCode} />
                <div className="flex flex-wrap gap-2">
                  {hiringCategories?.map((skill, index) => (
                    <span
                      key={index}
                      className="px-4 py-2 bg-blue-50 text-blue-600 rounded-full font-medium text-sm border border-blue-100"
                    >
                      {skill}
                    </span>
                  ))}
          ...
          <div className="w-full rounded-3xl  overflow-hidden">
            ...
            <div className='grid lg:grid-cols-3 gap-2'>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm col-span-2">
                <SectionHeader icon={FiExternalLink} title="Social Links" />
