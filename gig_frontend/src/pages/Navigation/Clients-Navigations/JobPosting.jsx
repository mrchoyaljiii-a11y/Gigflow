...
const JobPosting = () => {
    ...
    return (
        <div className="inset-0  flex justify-center items-center z-50 p-5 mb-13">
            <div className="w-full max-w-lg bg-[#F8F9FB] rounded-2xl overflow-hidden shadow-lg">
                ...
                <div className="relative flex items-center justify-center py-4 border-b border-gray-400 bg-white">
                    ...
                    <NavLink to="/home" className="absolute left-4 text-slate-500 hover:text-black">
                        <CiCircleRemove size={30} />
                    </NavLink>

                    <h2 className="text-lg font-semibold text-secondary border p-1 rounded-md">Create a New Job</h2>
                </div>
