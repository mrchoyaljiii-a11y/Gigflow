...
const Login = () => {
    ...
    return (
        <div className="max-w-md mx-auto mt-12 p-6 bg-white rounded shadow">
            ...
            <p className="mt-4 text-sm text-gray-600">Don't have an account? <span className='text-blue-600 font-semibold'> <NavLink to="/createAccount">Create Account</NavLink></span></p>
        </div>
    )
}
